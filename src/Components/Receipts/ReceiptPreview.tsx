...
const ReceiptPreview = ({receipt}: {receipt: Receipt}) => {
    ...
    return <div className="flex flex-col glass w-[280px]">
        <Link to={`/receipt/${receipt.id}`} className="text-light-text hover:text-light-text dark:hover:text-dark-text dark:text-dark-text">
