...
const USER_RECEIPT_FEED = BASE_API_ROUTES_URL + "Receipt/newest/subscribed"
...
export {SUBSCRIPTION_RECEIPTS_ROUTE, GOOGLE_LOGIN_ROUTE , DISCORD_LOGIN_ROUTE , GET_RECEIPTS_ROUTE, USER_INFO_ROUTE, 
    ...
    USER_PROFILE_ROUTE, USER_RECEIPTS_ROUTE, USER_CHANGE_USERNAME, BASE_ROUTE_URL, USER_RECEIPT_FEED  }